"""
Django settings for soundwave_backend project.
...
ROOT_URLCONF = 'soundwave_backend.urls'
...
WSGI_APPLICATION = 'soundwave_backend.wsgi.application'
...
# Inclure les fichiers du build Vue.js
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, '..', 'soundwave_frontend', 'dist'),
]
